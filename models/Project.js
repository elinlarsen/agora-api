...
const projectSchema= new Schema({
  ...
  tags : {type : Array, enum: ["culture", "environment", "security", "sport", "mobility", "digital", "education", "solidarity", "health", "cleanliness", "lifestyle", "economy"]},
  type: {type : String, enum: ["open", "close"], require: true},
  minimum_contribution : {type : Number},
  minimum_total_amount: {type: Number},
  minimu_amount_per_member : {type : Number},
  start_date : {type : Date, require: true},
  end_date : {type : Date, require: true},
  description: {type : String, require : true},
  status: {type : Array, enum: ["ideation", "planning", "financed", "ongoing", "done"]},
  public : {type: Boolean},
